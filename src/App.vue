    ...
    <div class="container text-light">
      ...
      <div class="row">
        ...
        <div class="col-lg text-left" >
          <div class="text-center">
            ...
            <p><i class="fa-brands fa-youtube"></i><a href="https://www.youtube.com/@TakanashiKiara">Takanashi Kiara Ch. hololive-EN</a></p>
          </div>
        </div>
      <div class="row">
        <p><br/></p>
      ...
      <div class="row text-center" data-aos="fade-up">
        ...
        <div class="video-container">
          <iframe width="560" height="315" style="border-radius: 1.5rem;box-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)" src="https://www.youtube.com/embed/pGPutam676Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <p><br/></p>
      </div>
      <hr/>
